...
namespace mac{
	 ...
	 */
	TweenItem::TweenItem( float* property, float from, float to, float seconds, EasingFunction ease, TweenCallback callback, void* callbackData ){
	 ...
	 * Add an Tween
	 */
	void Tween::addTween( float* property, float from, float to, float seconds, EasingFunction ease, TweenCallback callback, void* callbackData ){
	 ...
	 */
	void Tween::removeTween( float* property ){
