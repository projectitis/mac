...
namespace mac {
	...
	access5565 getAccessor5565( PixelFormat pixelFormat ) {
		switch ( pixelFormat ) {
			...
			case mac::PF_GRAYSCALE8: return get8as5565;
			case mac::PF_GRAYSCALE4: return get4as5565;
			case mac::PF_GRAYSCALE2: return get2as5565;
	...
	access8565 getAccessor8565( PixelFormat pixelFormat ) {
		switch ( pixelFormat ) {
			...
			case mac::PF_GRAYSCALE8: return get8as8565;
			case mac::PF_GRAYSCALE4: return get4as8565;
			case mac::PF_GRAYSCALE2: return get2as8565;
	...
	accessARGB getAccessorARGB( PixelFormat pixelFormat ) {
		switch ( pixelFormat ) {
			...
			case mac::PF_GRAYSCALE8: return get8asARGB;
			case mac::PF_GRAYSCALE4: return get4asARGB;
			case mac::PF_GRAYSCALE2: return get2asARGB;
	...
	access8888 getAccessor8888( PixelFormat pixelFormat ) {
		switch ( pixelFormat ) {
			...
			case mac::PF_GRAYSCALE8: return get8as8888;
			case mac::PF_GRAYSCALE4: return get4as8888;
			case mac::PF_GRAYSCALE2: return get2as8888;
